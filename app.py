...
def load_LSTM_model():
    ...
    return load_model("NEW_LSTM_model_Date_Time_2024_11_27_16_07_54___Loss_0.05249069631099701___Accuracy_0.9826388955116272.h5")
...
def predict(model, wav_filepath):
    ...
    emotions = {1 : 'shaanta', 2 : 'veera', 3 : 'hasya', 4 : 'karuna', 
                5 : 'raudra', 6 : 'bhayanaka', 7 : 'bhibhitsa', 8 : 'surprised'}
